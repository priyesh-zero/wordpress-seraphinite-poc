...
class Size extends PrimitiveValue {
	...
	*/
	...
	public function __construct($fSize, $sUnit = null, $bIsColorComponent = false, $iPos = 0) {
	...
	public static function parse(ParserState $oParserState, $bIsColorComponent = false) {
		...
		$nSize = $oParserState->currentPos();
		$sSize .= $oParserState->consumeExpression('@\\G[\\.\\d]*@S', true, false);
		$nSize = $oParserState->currentPos() - $nSize;
		...
		return new Size(floatval($sSize), $sUnit ? $sUnit : null, $bIsColorComponent, $iPos);
	}
