...
class PluginLic
{
	...
	static function Activate( $key )
	{
		...
		$licRes = LicCli::Action( $srvUrl, '594EDF52DE173808712397', LicCli::Act_Activate, $key, 'wordpress-accelerator', '2.22.5', Wp::GetSiteId(), Wp::GetSiteDisplayName() );
	...
	static function Deactivate()
	{
		...
		$licRes = LicCli::Action( $srvUrl, '594EDF52DE173808712397', LicCli::Act_Deactivate, $licInfo[ 'key' ], 'wordpress-accelerator', '2.22.5', Wp::GetSiteId( isset( $licInfo[ 'sid' ] ) ? null : 'OLD' ) );
		$licSrvRes = $licRes[ 'response' ];
		if( !$licSrvRes )
			$hr = $licRes[ 'hr' ];
		else
	...
	static function Update()
	{
		...
		$licRes = LicCli::Action( $srvUrl, '594EDF52DE173808712397', LicCli::Act_Check, $licInfo[ 'key' ], 'wordpress-accelerator', '2.22.5', Wp::GetSiteId( isset( $licInfo[ 'sid' ] ) ? null : 'OLD' ) );
		$licSrvRes = $licRes[ 'response' ];
		if( !$licSrvRes )
			return( $licRes[ 'hr' ] );
	...
	static function GetDataUrl( $item )
	{
		...
		return( LicCli::GetDataUrl( $srvUrl, '594EDF52DE173808712397', $licInfo[ 'key' ], 'wordpress-accelerator', '2.22.5', Wp::GetSiteId( isset( $licInfo[ 'sid' ] ) ? null : 'OLD' ), $features[ 0 ], $item ) );
	}
